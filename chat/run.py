...
def get_engine(args):
    ...
    return runner
def run_update_trt_llm_args(args, tokenizer, prompt_template, model_name, model_version, is_enc_dec, runtime_rank,stop_words_list, pad_id, end_id, bad_words_list):
...
def run_trt_llm(runner, args, is_enc_dec, runtime_rank,tokenizer, batch_input_ids, encoder_input_ids,
         decoder_input_ids, input_lengths, end_id, pad_id, stop_words_list, bad_words_list):
    with torch.no_grad():
