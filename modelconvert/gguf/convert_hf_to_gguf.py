...
if __name__ == '__main__':
    #python convert_hf_to_gguf.py /workspace/mnt/storage/xiangxin/trt-llama/Qwen1.5-7B-Chat --outfile /workspace/mnt/storage/xiangxin/trt-llama/llama.cpp/test----ff16.gguf
    #默认转f16
    main()
